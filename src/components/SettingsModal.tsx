...
export default function SettingsModal() {
  ...
  useEffect(() => {
    ...
    setActiveTab(saasMode && settingsTabRequest === 'data' ? 'general' : settingsTabRequest)
  }, [saasMode, settingsTabRequest, showSettings])

  useEffect(() => {
    if (saasMode && activeTab === 'data') setActiveTab('general')
  }, [activeTab, saasMode])
